...
export function FinaleQuestion() {
  ...
  const isFinalist = userId && finaleState
    ...
    <div className="flex min-h-svh items-center justify-center p-6">
      <div className="w-full max-w-2xl mx-auto space-y-6 animate-in fade-in duration-300">
        <div className="text-center space-y-2">
          <Badge variant="destructive" className="text-sm px-4 py-1 animate-pulse">
            SUDDEN DEATH
          </Badge>
          {finaleState && (
        ...
        <Card className="ring-2 ring-destructive/50 shadow-lg shadow-destructive/10">
